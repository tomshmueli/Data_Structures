from avl_template import AVLTreeList
import unittest
...
#         T.append(1)
#
#         self.assertEqual(T.successor(T.getRoot()).getValue(), 1)
#         self.assertEqual(T.successor(T.getRoot().getRight()), None)
#         self.assertEqual(T.predecessor(T.getRoot().getRight()).getValue(), 0)
